...
/* This examples demonstrates the construction of a grain boundary in a 3D
bicrystal.
 * The following is a snippet from the output generated by testGenerateGBs. In
this example,
...
Glide disconnection Burgers vector =   0.031135531135532801272
-0.02930402930402919992 -0.0018315018315027131734; norm =
0.042796049251092468935 Step height of glide disconnection =
0.40768712416676056165 Step height of non-glide disconnection 1=
0.22237479499852241815 Step height of non-glide disconnection 2=
0.18531232916825057799
-----------------------------------------------------------------------------
...
Glide disconnection Burgers vector =  0.80769230769237765344
-0.7307692307690558664 -0.07692307692309441336; norm = 1.0919284281982737372
...
int main() {
  ...
  try {
    ...
    /*! [period vector] */
    LatticeVector<dim> glideA(
        rv.cross(gb.nA.reciprocalLatticeVector()).latticeVector());
    LatticeVector<dim> periodC(
        bc.getLatticeDirectionInC(glideA).latticeVector());
    /*! [period vector] */
