...
#ifndef gbLAB_RationalLatticeDirection_h_
#define gbLAB_RationalLatticeDirection_h_
...
public:
  RationalLatticeDirection(const Rational<IntScalarType> &_rat,
                           const LatticeDirection<dim> &_dir);
  RationalLatticeDirection(const Rational<IntScalarType> &_rat,
                           const LatticeVector<dim> &v);
  RationalLatticeDirection(const LatticeVector<dim> &v);
  RationalLatticeDirection(const RationalLatticeDirection<dim> &other) =
      default;
  ...
  RationalLatticeDirection<dim> operator/(const IntScalarType &scalar) const;
  RationalLatticeDirection<dim>
  operator+(const RationalLatticeDirection<dim> &other) const;
  RationalLatticeDirection<dim>
  operator-(const RationalLatticeDirection<dim> &other) const;
  RationalLatticeDirection<dim>
  operator+(const LatticeVector<dim> &other) const;
  RationalLatticeDirection<dim>
  operator-(const LatticeVector<dim> &other) const;
