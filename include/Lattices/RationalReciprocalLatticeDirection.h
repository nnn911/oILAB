...
public:
  ...
  RationalReciprocalLatticeDirection(const Rational<IntScalarType> &_rat,
                                     const ReciprocalLatticeVector<dim> &v);
  RationalReciprocalLatticeDirection(const ReciprocalLatticeVector<dim> &v);
  RationalReciprocalLatticeDirection(
      const RationalReciprocalLatticeDirection<dim> &other) = default;
  RationalReciprocalLatticeDirection(
      RationalReciprocalLatticeDirection<dim> &&other) = default;
  VectorDimD cartesian() const;
  Rational<IntScalarType> dot(const LatticeVector<dim> &other) const;
  RationalReciprocalLatticeDirection<dim>
  operator*(const IntScalarType &scalar) const;
  RationalReciprocalLatticeDirection<dim>
  operator/(const IntScalarType &scalar) const;
  RationalReciprocalLatticeDirection<dim>
  operator+(const RationalReciprocalLatticeDirection<dim> &other) const;
  RationalReciprocalLatticeDirection<dim>
  operator-(const RationalReciprocalLatticeDirection<dim> &other) const;
  RationalReciprocalLatticeDirection<dim>
