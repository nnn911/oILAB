...
namespace oILAB {
template <int dim> struct LatticeCore {
  ...
  /*!
   * \brief Returns the integer coordinates of a vector \f$d\f$ with respect to
   * a lattices with structure matrix \f$\textbf A\f$.
   * @param v input direction
   * @param invA \f$\textbf A^{-1}\f$
   * @return integer coordinates
   */
  static VectorDimI integerCoordinates(const VectorDimD &d,
