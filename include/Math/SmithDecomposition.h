...
public:
  ...
  SmithDecomposition(const MatrixNi &A)
      : // D=U*A*V, A=X*D*Y
        ...
        /* init */ Y(MatrixNi::Identity()) { /*! The algorithm follows section 2
                                              * in GEORGE HAVAS AND BOHDAN S.
                                              * MAJEWSKI, Integer Matrix
                                              * Diagonalization, J. Symbolic
                                              * Computation (1997) 24, 399–408.
                                              */
